...
animation();
  ...
  return (
    <div className="middle-content" style={{ position: 'relative' }}>
  ...
  fontSize: "0.5em",
  textAlign: "center",
  background: "linear-gradient(0deg, rgba(34,193,195,1) 0%, rgba(45,122,253,1) 100%)",
  ...
  If you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we'll give you a truly out of this world experience.
        ...
        <div style={{ display: 'flex', flexDirection: 'row', gap: '1rem' }}>
          ...
          <button class="startpage">Choose Your Adventure</button>
        </div>
        </div>
    </div>
  );
